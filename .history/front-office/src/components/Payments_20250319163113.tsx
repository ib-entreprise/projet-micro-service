      ...
      <div>
        ...
        <ul className="space-y-2">
          {payments.map((payment) => (
            <li
              key={payment.id}
              className="p-3 bg-pink-200 rounded-md flex justify-between items-center"
            >
              <div>
              ...
              <button
                ...
                className="px-4 py-2 bg-red-500 text-gray-900 rounded-md hover:bg-red-600 transition duration-300"
              >
                Delete
              </button>
            </li>
